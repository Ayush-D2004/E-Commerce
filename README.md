...
1. **Clone the repository**:
   ```bash
   git clone https://github.com/your-username/scaler-ecommerce.git
   cd scaler-ecommerce
   ```
...
2. **Backend Setup**:
   ...
   python scripts/ingest_data.py  # Seed 33k rows
   python scripts/generate_recommendations.py # Build vector recs
   python app/main.py
   ```
